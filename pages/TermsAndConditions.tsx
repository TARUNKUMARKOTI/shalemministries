  ...
  return (
    <div className="pt-24 animate-fade-in min-h-screen bg-white dark:bg-black transition-colors duration-200">
      <div className="container mx-auto px-6 py-20 max-w-4xl">
        <h1 className="text-5xl md:text-7xl font-extrabold tracking-tighter mb-6 text-black dark:text-white">Terms & Conditions</h1>
        ...
        <div className="prose prose-lg max-w-none space-y-8">
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-black dark:text-white">2. Use License</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-black dark:text-white">3. Donations and Contributions</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-black dark:text-white">4. Privacy and Data Protection</h2>
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-black dark:text-white">6. Disclaimer</h2>
            <p className="text-gray-600 leading-relaxed mb-4">
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-black dark:text-white">7. Limitations</h2>
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-black dark:text-white">8. Revisions and Errata</h2>
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-black dark:text-white">9. Links</h2>
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-black dark:text-white">10. Modifications</h2>
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-black dark:text-white">11. Contact Information</h2>
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
