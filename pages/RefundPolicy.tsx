  ...
  return (
    <div className="pt-24 animate-fade-in min-h-screen bg-white">
      <div className="container mx-auto px-6 py-20 max-w-4xl">
        <h1 className="text-5xl md:text-7xl font-extrabold tracking-tighter mb-6">Refund Policy</h1>
        ...
        <div className="prose prose-lg max-w-none space-y-8">
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4">2. Donation Refunds</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4">3. Processing Refunds</h2>
            <p className="text-gray-600 leading-relaxed mb-4">
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4">4. Recurring Donations</h2>
            <p className="text-gray-600 leading-relaxed mb-4">
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4">5. Tax-Deductible Donations</h2>
            <p className="text-gray-600 leading-relaxed">
